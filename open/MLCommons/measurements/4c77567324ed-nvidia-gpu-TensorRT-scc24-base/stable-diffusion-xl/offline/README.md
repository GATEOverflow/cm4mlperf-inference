...
Platform: 4c77567324ed-nvidia-gpu-TensorRT-scc24-base

Model Precision: int8

### Accuracy Results 
`CLIP_SCORE`: `15.61869`, Required accuracy for closed division `>= 31.68632` and `<= 31.81332`
`FID_SCORE`: `234.35928`, Required accuracy for closed division `>= 23.01086` and `<= 23.95008`

### Performance Results 
`Samples per second`: `1.14313`
