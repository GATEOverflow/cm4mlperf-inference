...
cm pull repo gateoverflow@cm4mlops --checkout=77f7583144781a46f01683826fcfb98993bf76fa
...
Platform: ee0bcb31c18c-nvidia-gpu-TensorRT-scc24-base

Model Precision: int8

### Accuracy Results 
`CLIP_SCORE`: `15.54441`, Required accuracy for closed division `>= 31.68632` and `<= 31.81332`
`FID_SCORE`: `233.64225`, Required accuracy for closed division `>= 23.01086` and `<= 23.95008`

### Performance Results 
`Samples per second`: `1.14176`
